...
var Kalendae = function (targetElement, options) {
	...
	while (j--) {
		...
		//store each calendar views for easy redrawing
		calendars.push({
			caption:$caption,
			days:dayNodes
		});
	...
	util.addEvent($container, 'mousedown', function (event, target) {
		...
		//NEXT MONTH BUTTON
			if (!self.disableNext && self.publish('views-changed', self, ['next-month']) !== false) {
		...
		//PREVIOUS MONTH BUTTON
			if (!self.disablePreviousMonth && self.publish('views-changed', self, ['previous-month']) !== false) {
		...
		//NEXT MONTH BUTTON
			if (!self.disableNext && self.publish('views-changed', self, ['next-year']) !== false) {
		...
		//PREVIOUS MONTH BUTTON
			if (!self.disablePreviousMonth && self.publish('views-changed', self, ['previous-year']) !== false) {
